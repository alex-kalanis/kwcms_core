...
class SingleTemplate extends ATemplate
{
    ...
    protected function fillInputs(): void
    {
        ...
        $this->addInput('{THUMB_DESCRIPTION}', Lang::get('Thumbnail'));
        $this->addInput('{FORM_THUMB_START}');
        $this->addInput('{INPUT_THUMB_SUBMIT}');
        $this->addInput('{FORM_THUMB_END}');
        $this->addInput('{TITLE_DESC}', Lang::get('Description'));
        ...
        $this->addInput('{TITLE_RENAME}', Lang::get('Rename'));
        ...
        $this->addInput('{TITLE_COPY}', Lang::get('Copy'));
        ...
        $this->addInput('{TITLE_MOVE}', Lang::get('Move'));
        ...
        $this->addInput('{TITLE_PRIMARY}', Lang::get('As gallery\'s primary thumb'));
        $this->addInput('{FORM_PRIMARY_START}');
        $this->addInput('{INPUT_PRIMARY_SUBMIT}');
        $this->addInput('{FORM_PRIMARY_END}');
        $this->addInput('{TITLE_DELETE}', Lang::get('Delete'));
    ...
    public function setData(string $fullLink, string $thumbLink, Forms\FileThumbForm $formThumb, Forms\DescForm $formDesc, Forms\FileRenameForm $formRename, Forms\FileActionForm $formCopy, Forms\FileActionForm $formMove, Forms\FileThumbForm $formPrimary, Forms\FileDeleteForm $formDelete): self
    {
        ...
        $this->updateItem('{INPUT_RENAME_SUBMIT}', $formRename->getControl('saveDesc')->renderInput());
        $this->updateItem('{INPUT_RENAME_RESET}', $formRename->getControl('resetDesc')->renderInput());
        ...
        $this->updateItem('{INPUT_COPY_SUBMIT}', $formCopy->getControl('saveDesc')->renderInput());
        $this->updateItem('{INPUT_COPY_RESET}', $formCopy->getControl('resetDesc')->renderInput());
        ...
        $this->updateItem('{INPUT_MOVE_SUBMIT}', $formMove->getControl('saveDesc')->renderInput());
        $this->updateItem('{INPUT_MOVE_RESET}', $formMove->getControl('resetDesc')->renderInput());

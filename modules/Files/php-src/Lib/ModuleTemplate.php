...
class ModuleTemplate extends ATemplate
{
    ...
    protected function fillInputs(): void
    {
        ...
        $this->addInput('{TEXT_FILE_CLONE}', Lang::get('files.file.clone.short'));
        ...
        $this->addInput('{LINK_DIR_CLONE}', Lang::get('files.dir.clone.short'));
    ...
    public function setData(
        string $content, string $linkDashboard,
        string $linkFileUpload, string $linkFileCopy, string $linkFileMove, string $linkFileClone, string $linkFileRename, string $linkFileDelete, string $linkFileRead,
        string $linkDirNew, string $linkDirCopy, string $linkDirMove, string $linkDirClone, string $linkDirRename, string $linkDirDelete, string $linkChDir
    ): self
    {
        ...
        $this->updateItem('{LINK_FILE_CLONE}', $linkFileClone);
        ...
        $this->updateItem('{LINK_DIR_CLONE}', $linkDirClone);

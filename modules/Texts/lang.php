...
$lang = [
    'eng' => [
        "texts.new_file" => "New file",
        "texts.open_file" => "Open file",
        "texts.edit_file" => "Edit file",
        "texts.save_file" => "Save",
        "texts.continue" => "Continue",
        "texts.set_file" => "Set file",
    ...
    'fra' => [
        "texts.new_file" => "Noveau fichier",
        "texts.open_file" => "Ouvri le fichier",
        "texts.edit_file" => "Modifier",
        "texts.save_file" => "Enregister",
        "texts.continue" => "Continuer",
        "texts.set_file" => "Choisir le fichier",
    ...
    'cze' => [
        "texts.new_file" => "Nov&#x00FD; soubor",
        "texts.open_file" => "Otev&#x0159;&#x00ED;t soubor",
        "texts.edit_file" => "Upravuj",
        "texts.save_file" => "Ulo&#x017E;en&#x00ED;",
        "texts.continue" => "Pokra&#x010D;ovat",
        "texts.set_file" => "Vyber soubor",

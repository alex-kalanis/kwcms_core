...
\kalanis\kw_confs\Config::set('Core', 'page.default_display_module', 'Transcode');
\kalanis\kw_confs\Config::set('Core', 'page.site_name', 'KWCMS3 Char Translator');
\kalanis\kw_confs\Config::set('Core', 'page.page_title', 'Transcode');
